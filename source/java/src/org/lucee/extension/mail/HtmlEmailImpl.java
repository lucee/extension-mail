...
public final class HtmlEmailImpl extends MultiPartEmail {
	...
	/**
	 * Text part of the message. This will be used as alternative text if the email
	 * client does not support HTML messages.
	 */
	 ...
	 *
	 * <p>
	 * This method overrides the MultiPartEmail setMsg() method in order to send an
	 * HTML message instead of a full text message in the mail body. The message is
	 * formatted in HTML for the HTML part of the message, it is let as is in the
	 * alternate text part.
	 *
	 * @param msg
	 *            A String.
	...
	public Email setMsg(String msg) throws EmailException {
		...
		setHtmlMsg(
				new StringBuilder().append("<html><body><pre>").append(msg).append("</pre></body></html>").toString());
	 ...
	 * allows, for instance, to add inline images to the email. Inline files may be
	 * referenced with a <code>cid:xxxxxx</code> URL, where xxxxxx is the Content-ID
